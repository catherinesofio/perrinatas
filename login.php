        ...
        if ($num_rows > 0) {
            ...
            if ($password != $pass) {
                echo "<script type='text/javascript'>
                    setTimeout(() => {
                        show_modal('danger', '<i class=\"fa-solid fa-triangle-exclamation\"></i> Error', '<h5>Lo sentimos, pero la contraseña es erronea. Por favor, ¡intentalo nuevamente!</h5>')
                    }, 1);
                </script>";
            } else {
                $_SESSION["id"] = $id;
            ...
            echo "<script type='text/javascript'>
                setTimeout(() => {
                    show_modal('warning', '<i class=\"fa-solid fa-triangle-exclamation\"></i> Error', '<h5>Lo sentimos, pero el usuario <span class=\"text-warning\">$username</span> no existe. <a href=\"/perrinatas/register.php\">¡Registrate!</a></h5>')
                }, 1);
            </script>";
        }
    }
...
<html lang="es">
    ...
    <body>
        ...
        <!-- Session Storage -->
        <script type="text/javascript" src="scripts/session_storage.js"></script>
